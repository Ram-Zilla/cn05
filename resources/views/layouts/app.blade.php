...
<head>
    ...
    <script type="text/javascript" src="{{ url('') }}/resources/assets/js/jquery-1.11.1.min.js"></script>
    <!-- 2. Подключить скрипт moment-with-locales.min.js для работы с датами -->
    <script type="text/javascript" src="{{ url('') }}/resources/assets/js/moment-with-locales.min.js"></script>
    ...
    <script type="text/javascript" src="{{ url('') }}/resources/assets/js/bootstrap-datetimepicker.min.js"></script>
    ...
    <link rel="stylesheet" href="{{ url('') }}/resources/assets/css/bootstrap-datetimepicker.min.css" />
      ...
      <link href="{{ url('') }}/resources/assets/css/bootstrap-theme.css" rel="stylesheet">
    <script type="text/javascript" src="{{ url('') }}/resources/assets/js/config.json"></script>
